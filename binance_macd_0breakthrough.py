...
def macd(symbol):
    ...
    klines = client.klines(symbol, '1h', limit=500)
...
############코인 롱 구매###############
            if (0 > old_old_macd) and (0 <= old_macd) and (0 < now_macd) and (count_all_buy == 'true'):
...
############코인 숏 구매############
            if (0 < old_old_macd) and (0 >= old_macd) and (0 > now_macd) and (count_all_sell == 'true'):
...
############물타기(롱)############
                    if (0 > old_old_macd) and (0 <= old_macd) and (0 < now_macd) and (now > globals()['buytime_buy_{}'.format(n)]) and ((float(globals()['last_current_price_buy_{}'.format(n)]) * float(globals()['increase_water_buy_{}'.format(n)])) > globals()['current_price_buy_{}'.format(n)]):
                        #선물잔고조회
                        balance = binance.fetch_balance(params={"type": "future"})
                        ...
                        if (globals()['last_buy_money_{}'.format(n)]*2 < balance['USDT']['free']) :
                            ...
                            if maxQty > (globals()['buy_money_buy_{}'.format(n)]*2) :
                                ...
                                print('old_old_macd(long)', old_old_macd)
                                print('old_macd(long)', old_macd)
                                print('----------------------------------------------------')
                                time.sleep(1)  
                            else :
...
############물타기(숏)############
                    if (0 < old_old_macd) and (0 >= old_macd) and (0 > now_macd) and (now > globals()['buytime_sell_{}'.format(n)]) and ((float(globals()['last_current_price_sell_{}'.format(n)]) * float(globals()['increase_water_sell_{}'.format(n)])) < globals()['current_price_sell_{}'.format(n)]):
                        #선물잔고조회
                        balance = binance.fetch_balance(params={"type": "future"})
                        ...
                        if (globals()['last_sell_money_{}'.format(n)]*2 < balance['USDT']['free']) :
                            ...
                            if maxQty > (globals()['buy_money_sell_{}'.format(n)]*2) :
                                ...
                                print('old_old_macd(short)', old_old_macd)
                                print('old_macd(short)', old_macd)
                                print('----------------------------------------------------')
                                time.sleep(1) 
                            else :
